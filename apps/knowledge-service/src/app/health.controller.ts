...
export class HealthController {
  constructor(private readonly health: HealthCheckService, private readonly indicator: ServiceHealthIndicator, private readonly redis: RedisService, private readonly kafka: KafkaProducerService) {}
  @Get('live')
  @HealthCheck()
